...
<div class="hpm_spoiler2">
<div class="hpm_spoiler2_headdiv"><input class="hpm_spoiler2_headinput" onclick="hpm_spoiler(this.parentNode.parentNode);" type="submit" value="&rArr; Frage"/></div>
<div>
<div class="hpm_spoiler_body" style="border:1px solid #fafafa; padding:5px 5px 0px 15px;">
<div>Antwort</div>
</div>
</div>
</div>
